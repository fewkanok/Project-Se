...
function CurriculumMapTab() {
  ...
  return (
    <div className="text-white">
      ...
      {/* ── Legend ── */}
      <div className="flex flex-wrap items-center gap-4 mt-8 pt-5 text-xs text-slate-500"
        style={{ borderTop: '1px solid rgba(255,255,255,0.07)' }}>
        <span className="text-slate-600 font-bold uppercase tracking-wider text-[10px]">Legend</span>
        {[
