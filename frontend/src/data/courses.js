...
export const roadmapData = [
  ...
  // --- TRACK COURSES (วิชาในหน้าแบ่งสาย — ไม่ได้อยู่ใน roadmap หลัก) ---
  {
    year: "Track Courses",
    semesters: [
      {
        ...
        courses: [
          {
              ...
              topics: { midterm: ["ระบบเลขฐาน","Boolean Algebra","Logic Gates","Combinational Circuits (MUX, Adder)"], final: ["Flip-Flop & Latch","Sequential Circuits","Finite State Machine","HDL เบื้องต้น"] },
              isTrackOnly: true,
            },
          {
              id: "040613703",
              ...
              difficulty: 3.8,
              satisfaction: 4.4,
              scoring: [{ label: "Lab", percent: 30, color: "bg-green-500" }, { label: "Project", percent: 40, color: "bg-blue-500" }, { label: "Presentation", percent: 30, color: "bg-purple-500" }],
              topics: { midterm: ["Data Collection & Preprocessing","Feature Engineering","Model Training Pipeline","Version Control for ML"], final: ["Model Deployment (Flask/FastAPI)","Docker & Containerization","MLOps Basics","AI Ethics & Bias"] },
              isTrackOnly: true,
            },
          {
              id: "040613152",
              code: "040613152",
              name: "Selected Topics in Computer Science II",
              credits: 3,
              prereq: null,
              ...
              difficulty: 3,
              satisfaction: 4,
              scoring: [{ label: "Midterm", percent: 30, color: "bg-orange-500" }, { label: "Final", percent: 30, color: "bg-red-500" }, { label: "Report/Project", percent: 40, color: "bg-blue-500" }],
              topics: { midterm: ["หัวข้อพิเศษ Part 1","Review & Discussion"], final: ["หัวข้อพิเศษ Part 2","Presentation & Report"] },
              isTrackOnly: true,
            },
          {
              id: "040613705",
              ...
              difficulty: 4,
              satisfaction: 4,
              scoring: [{ label: "Lab", percent: 30, color: "bg-green-500" }, { label: "Midterm", percent: 30, color: "bg-orange-500" }, { label: "Final", percent: 20, color: "bg-red-500" }, { label: "Project", percent: 20, color: "bg-blue-500" }],
              topics: { midterm: ["Big Data Concepts (5V)","Hadoop Ecosystem","HDFS & MapReduce","Apache Spark Basics"], final: ["Kafka & Stream Processing","Data Lake vs Data Warehouse","ETL Pipeline Design","Cloud Big Data Services"] },
              isTrackOnly: true,
            },
          {
              id: "040613706",
              ...
              difficulty: 4,
              satisfaction: 4.3,
              scoring: [{ label: "Assignment", percent: 20, color: "bg-green-500" }, { label: "Midterm", percent: 30, color: "bg-orange-500" }, { label: "Final", percent: 30, color: "bg-red-500" }, { label: "Project", percent: 20, color: "bg-blue-500" }],
              topics: { midterm: ["Text Preprocessing","Tokenization & Stemming","POS Tagging","Word Embeddings (Word2Vec, GloVe)"], final: ["Sentiment Analysis","Named Entity Recognition","Sequence-to-Sequence Models","BERT & Transformer for NLP"] },
              isTrackOnly: true,
            },
          {
              id: "040613707",
              ...
              difficulty: 4.2,
              satisfaction: 4.4,
              scoring: [{ label: "Lab", percent: 25, color: "bg-green-500" }, { label: "Midterm", percent: 30, color: "bg-orange-500" }, { label: "Final", percent: 25, color: "bg-red-500" }, { label: "Project", percent: 20, color: "bg-blue-500" }],
              topics: { midterm: ["Image Representation","Image Filtering & Transformation","Edge Detection","Feature Extraction (SIFT, HOG)"], final: ["Object Detection (YOLO, R-CNN)","Image Segmentation","Face Recognition","Video Analysis & Tracking"] },
              isTrackOnly: true,
            },
          {
              id: "040613605",
              code: "040613605",
              name: "Penetration Testing and Protection",
              credits: 3,
              ...
              difficulty: 4.5,
              satisfaction: 4.7,
              scoring: [{ label: "Lab", percent: 30, color: "bg-green-500" }, { label: "CTF/Challenge", percent: 20, color: "bg-purple-500" }, { label: "Midterm", percent: 25, color: "bg-orange-500" }, { label: "Final Report", percent: 25, color: "bg-red-500" }],
              topics: { midterm: ["Recon & OSINT","Scanning & Enumeration","Vulnerability Analysis","Exploitation Basics"], final: ["Post-Exploitation","Web Application Attacks","Social Engineering","Pentest Report Writing"] },
              isTrackOnly: true,
            },
          {
              id: "040613603",
              ...
              difficulty: 4,
              satisfaction: 4.2,
              scoring: [{ label: "Lab/Code Review", percent: 30, color: "bg-green-500" }, { label: "Midterm", percent: 30, color: "bg-orange-500" }, { label: "Final", percent: 30, color: "bg-red-500" }, { label: "Project", percent: 10, color: "bg-blue-500" }],
              topics: { midterm: ["Secure Coding Principles","Buffer Overflow & Memory Safety","Input Validation","SQL Injection Prevention"], final: ["OWASP Top 10","Authentication & Session Management","Cryptography in Code","SSDLC & Code Audit"] },
              isTrackOnly: true,
            },
          {
              id: "040613505",
              ...
              difficulty: 3,
              satisfaction: 4.3,
              scoring: [{ label: "Lab", percent: 40, color: "bg-green-500" }, { label: "Midterm", percent: 30, color: "bg-orange-500" }, { label: "Final", percent: 30, color: "bg-red-500" }],
              topics: { midterm: ["UNIX Filesystem & Navigation","File Permissions & User Management","Text Processing (grep/sed/awk)","Regular Expressions"], final: ["Shell Scripting","Process & Job Control","Networking Tools (ssh, netstat)","Cron & Task Automation"] },
              isTrackOnly: true,
            },
          {
              id: "040613506",
              ...
              difficulty: 3.5,
              satisfaction: 4.1,
              scoring: [{ label: "Lab", percent: 40, color: "bg-green-500" }, { label: "Midterm", percent: 25, color: "bg-orange-500" }, { label: "Final", percent: 25, color: "bg-red-500" }, { label: "Project", percent: 10, color: "bg-blue-500" }],
              topics: { midterm: ["Boot Process & Init System (systemd)","Package Management (apt/yum)","Disk & Storage Management (LVM)","User & Group Administration"], final: ["Network Interface Configuration","DNS & DHCP Server Setup","Security Hardening","Backup & Recovery"] },
              isTrackOnly: true,
            },
          {
              id: "040613801",
              ...
              difficulty: 4,
              satisfaction: 4.2,
              scoring: [{ label: "Lab", percent: 30, color: "bg-green-500" }, { label: "Midterm", percent: 30, color: "bg-orange-500" }, { label: "Final", percent: 30, color: "bg-red-500" }, { label: "Project", percent: 10, color: "bg-blue-500" }],
              topics: { midterm: ["2D/3D Coordinate Systems","Transformation Matrix (Translate/Rotate/Scale)","Viewing & Projection","Line & Polygon Rendering"], final: ["Lighting & Shading Models","Texture Mapping","Hidden Surface Removal","OpenGL Pipeline"] },
              isTrackOnly: true,
            },
          {
              id: "040613802",
              ...
              difficulty: 3.5,
              satisfaction: 4.8,
              scoring: [{ label: "Lab/Game Dev", percent: 30, color: "bg-green-500" }, { label: "Midterm", percent: 25, color: "bg-orange-500" }, { label: "Final", percent: 25, color: "bg-red-500" }, { label: "Final Game Project", percent: 20, color: "bg-blue-500" }],
              topics: { midterm: ["Game Design Fundamentals","Game Loop & Rendering","Input & Collision Detection","2D Platformer Basics"], final: ["Sprite Animation & Particle System","Game AI (Pathfinding)","Audio & Sound Effects","Game Polishing & Publishing"] },
              isTrackOnly: true,
            },
          {
              id: "040613804",
              ...
              difficulty: 3.5,
              satisfaction: 4.5,
              scoring: [{ label: "Portfolio", percent: 50, color: "bg-blue-500" }, { label: "Midterm Project", percent: 25, color: "bg-orange-500" }, { label: "Final Project", percent: 25, color: "bg-red-500" }],
              topics: { midterm: ["3D Viewport Navigation","Polygon Modeling (Box/Sculpt)","UV Unwrapping","Basic Materials & Textures"], final: ["Rigging & Weight Painting","Keyframe Animation","Lighting Setup","Rendering & Post-Processing"] },
              isTrackOnly: true,
            },
          {
              id: "040613805",
              ...
              difficulty: 4,
              satisfaction: 4.4,
              scoring: [{ label: "Animation Projects", percent: 50, color: "bg-blue-500" }, { label: "Midterm", percent: 25, color: "bg-orange-500" }, { label: "Final", percent: 25, color: "bg-red-500" }],
              topics: { midterm: ["12 Principles of Animation","Keyframe & Interpolation","Forward & Inverse Kinematics","Character Rigging"], final: ["Motion Capture & Retargeting","Particle & Fluid Simulation","Procedural Animation","Animation Rendering Pipeline"] },
              isTrackOnly: true,
            },
          {
              id: "040613806",
              ...
              difficulty: 4.2,
              satisfaction: 4.3,
              scoring: [{ label: "Render Portfolio", percent: 40, color: "bg-blue-500" }, { label: "Midterm", percent: 30, color: "bg-orange-500" }, { label: "Final", percent: 30, color: "bg-red-500" }],
              topics: { midterm: ["Light & Color Theory","Local vs Global Illumination","Phong & Blinn-Phong Shading","Shadow Mapping"], final: ["Ray Tracing & Path Tracing","Physically Based Rendering (PBR)","HDRI & Environment Lighting","GLSL Shader Programming"] },
              isTrackOnly: true,
            },
          {
              id: "040613803",
              ...
              difficulty: 3.8,
              satisfaction: 4.7,
              scoring: [{ label: "Project", percent: 40, color: "bg-blue-500" }, { label: "Lab Demo", percent: 20, color: "bg-green-500" }, { label: "Midterm", percent: 20, color: "bg-orange-500" }, { label: "Final", percent: 20, color: "bg-red-500" }],
              topics: { midterm: ["VR/AR/MR Concepts","HMD Hardware & Tracking","VR Rendering & Comfort","Unity XR Setup"], final: ["Marker-based & Markerless AR","Spatial UI Design","Hand Tracking & Gestures","XR Application Development"] },
              isTrackOnly: true,
            },
          {
              id: "040613901",
              ...
              satisfaction: 4,
              scoring: [{ label: "Lab", percent: 30, color: "bg-green-500" }, { label: "Midterm", percent: 30, color: "bg-orange-500" }, { label: "Final", percent: 30, color: "bg-red-500" }, { label: "Project", percent: 10, color: "bg-blue-500" }],
              topics: { midterm: ["Microcontroller Architecture (ARM/AVR)","GPIO & Interrupts","Timer & PWM","Serial Communication (UART/SPI/I2C)"], final: ["Real-Time OS Basics","Sensor & Actuator Interfacing","ADC/DAC","Embedded System Design Project"] },
              isTrackOnly: true,
            },
          {
              id: "040613904",
              code: "040613904",
              name: "Robotic Science and Control System",
              credits: 3,
              prereq: "040613901",
              ...
              difficulty: 4.5,
              satisfaction: 4.5,
              scoring: [{ label: "Lab", percent: 30, color: "bg-green-500" }, { label: "Midterm", percent: 25, color: "bg-orange-500" }, { label: "Final", percent: 25, color: "bg-red-500" }, { label: "Robot Project", percent: 20, color: "bg-blue-500" }],
              topics: { midterm: ["Robot Anatomy & DOF","Forward & Inverse Kinematics","Sensor Fusion","PID Control"], final: ["ROS Framework","Motion Planning (A*, RRT)","SLAM เบื้องต้น","Computer Vision for Robotics"] },
              isTrackOnly: true,
            },
          {
              id: "040613903",
              code: "040613903",
              name: "Geospatial Information Technology for Smart City",
              credits: 3,
              prereq: "040613301",
              ...
              difficulty: 3,
              satisfaction: 4,
              scoring: [{ label: "Midterm", percent: 30, color: "bg-orange-500" }, { label: "Final", percent: 30, color: "bg-red-500" }, { label: "GIS Project", percent: 40, color: "bg-blue-500" }],
              topics: { midterm: ["GIS Fundamentals","Coordinate Systems & Projections","Spatial Data Types (Vector/Raster)","Remote Sensing"], final: ["Open Data & OpenStreetMap","Spatial Analysis","Smart City Applications","Web Mapping (Leaflet/Mapbox)"] },
              isTrackOnly: true,
            },
          {
              id: "040613153",
              code: "040613153",
              name: "Selected Topics in Computer Science III",
              credits: 3,
              prereq: null,
            ...
            },
          {
              ...
              difficulty: 3.5,
              satisfaction: 4.2,
              scoring: [{ label: "Midterm", percent: 30, color: "bg-orange-500" }, { label: "Final", percent: 30, color: "bg-red-500" }, { label: "Smart Contract Project", percent: 40, color: "bg-blue-500" }],
              topics: { midterm: ["Blockchain Fundamentals & Cryptography","Bitcoin & Distributed Ledger","Consensus Mechanisms (PoW/PoS)","Ethereum & EVM"], final: ["Smart Contract (Solidity)","DeFi & NFT Concepts","Blockchain Security","Enterprise Blockchain (Hyperledger)"] },
              isTrackOnly: true,
            },
          {
              id: "040613412",
              ...
              difficulty: 3.8,
              satisfaction: 4.6,
              scoring: [{ label: "Lab/Assignment", percent: 30, color: "bg-green-500" }, { label: "Midterm", percent: 25, color: "bg-orange-500" }, { label: "Final", percent: 20, color: "bg-red-500" }, { label: "Full-Stack Project", percent: 25, color: "bg-blue-500" }],
              topics: { midterm: ["React/Vue Fundamentals & Component","State Management","Routing & Navigation","API Integration"], final: ["Backend Framework (Express/Django)","Authentication (JWT/OAuth)","Docker & Deployment","Testing & CI/CD"] },
              isTrackOnly: true,
            },
          {
              id: "040613421",
              ...
              difficulty: 3.8,
              satisfaction: 4.5,
              scoring: [{ label: "Lab", percent: 30, color: "bg-green-500" }, { label: "Midterm", percent: 25, color: "bg-orange-500" }, { label: "Final", percent: 20, color: "bg-red-500" }, { label: "App Project", percent: 25, color: "bg-blue-500" }],
              topics: { midterm: ["Mobile Platform Overview","UI Components & Layouts","Navigation & Routing","State Management"], final: ["REST API Integration","Local Storage & SQLite","Camera, GPS & Sensors","App Publishing & Store"] },
              isTrackOnly: true,
            },
          {
              id: "040613521",
              code: "040613521",
              name: "Selected Topics in Computer Science I",
              credits: 3,
              prereq: null,
            ...
            },
          {
              ...
              difficulty: 4,
              satisfaction: 3.9,
              scoring: [{ label: "Midterm", percent: 35, color: "bg-orange-500" }, { label: "Final", percent: 35, color: "bg-red-500" }, { label: "Assignment", percent: 30, color: "bg-green-500" }],
              topics: { midterm: ["Language Design Principles","Syntax & BNF Grammar","Lexical Analysis & Parsing","Type Systems & Checking"], final: ["Functional Programming (Haskell/Lisp)","Logic Programming (Prolog)","Memory Management","Concurrency & Parallelism"] },
              isTrackOnly: true,
            },
          {
              id: "040613307",
              ...
              difficulty: 3.5,
              satisfaction: 4,
              scoring: [{ label: "Midterm", percent: 30, color: "bg-orange-500" }, { label: "Final", percent: 30, color: "bg-red-500" }, { label: "Testing Lab/Project", percent: 40, color: "bg-green-500" }],
              topics: { midterm: ["Testing Fundamentals & V-Model","Black-box Testing (Equivalence/Boundary)","White-box Testing (Coverage)","Unit Testing (JUnit/pytest)"], final: ["Integration & System Testing","TDD & BDD","Test Automation (Selenium)","Performance & Security Testing"] },
              isTrackOnly: true,
            },
          {
              id: "040613305",
              ...
              difficulty: 3.8,
              satisfaction: 4,
              scoring: [{ label: "Midterm", percent: 30, color: "bg-orange-500" }, { label: "Final", percent: 30, color: "bg-red-500" }, { label: "Architecture Document", percent: 40, color: "bg-blue-500" }],
              topics: { midterm: ["Architecture Styles & Patterns","Layered & Pipe-and-Filter","MVC & MVP","GoF Design Patterns (Creational/Structural)"], final: ["GoF Design Patterns (Behavioral)","Microservices Architecture","Event-driven Architecture","Architecture Quality Attributes (ATAM)"] },
              isTrackOnly: true,
            },
          {
              id: "040613111",
              code: "040613111",
              name: "Digital and Logic Systems",
              credits: 3,
              prereq: null,
              ...
              satisfaction: 3.7,
              scoring: [{ label: "Midterm", percent: 35, color: "bg-orange-500" }, { label: "Final", percent: 35, color: "bg-red-500" }, { label: "Lab", percent: 20, color: "bg-green-500" }, { label: "Quiz", percent: 10, color: "bg-yellow-400" }],
              topics: { midterm: ["Number Systems & Codes","Boolean Algebra & Theorems","Logic Gates & Circuits","Karnaugh Map"], final: ["Combinational Logic Design","Adders, Encoders, MUX","Flip-Flops & Latches","Sequential Logic & FSM"] },
              isTrackOnly: true,
            },
          {
              id: "040613308",
              ...
              credits: 3,
              prereq: "040613302",
              description: "ศึกษากระบวนการระบุ วิเคราะห์ และจัดการความต้องการของระบบซอฟต์แวร์ ครอบคลุม Elicitation Techniques, Use Cases, User Stories, Requirements Prioritization และ Requirements Validation ตาม IEEE 29148",
              professors: ["ผศ.ดร.คันธารัตน์ อเนกบุณย์"],
              difficulty: 3.2,
              satisfaction: 3.9,
              scoring: [{ label: "Midterm Exam", percent: 30, color: "bg-orange-500" }, { label: "Final Exam", percent: 30, color: "bg-red-500" }, { label: "RE Document & Presentation", percent: 40, color: "bg-blue-500" }],
              topics: { midterm: ["Requirements Types & Sources","Elicitation Techniques (Interview, Observation, Prototyping)","Use Cases & User Stories","Requirements Modeling (DFD, State Diagram)","Requirements Prioritization (MoSCoW)"], final: ["Requirements Validation & Verification","Traceability Matrix","Change Management Process","RE Tools (JIRA, Confluence)","IEEE 29148 Standard","Final RE Document Presentation"] },
              isTrackOnly: true,
            },
        ]
      }
